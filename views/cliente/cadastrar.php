...
include_once "moodels/cliente.php";
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cliente[cpf]" placeholder="Número do CPF">
                </div>
            </div>
        </div>
...
if (isset($_POST['cliente'])) {
    ...
    echo '<h1 class="text-center">Cliente <b>'. $_POST['cliente']['nome-cliente'] . '</b> cadastrado com sucesso.</h1>';
}
?>